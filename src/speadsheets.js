...
googleSheet.sheetInit = function (uri, name) {
  _mySheet_.sheetUrl = uri.split('/edit')[0] + '/edit';
  _mySheet_.sheetName = name;
};

googleSheet.sheetWriteData = function (type, data, range) {
  let sendData;
  let arrayRow = 0;
  let arrayColumn = 0;
...
googleSheet.sheetReadData = function () {
  let parameter = {
    sheetUrl: _mySheet_.sheetUrl,
    sheetName: _mySheet_.sheetName
  }
...
googleSheet.sheetFeature = function (action, type, num, addNum) {
  let parameter = {
    sheetUrl: _mySheet_.sheetUrl,
    sheetName: _mySheet_.sheetName,
    action: action,
